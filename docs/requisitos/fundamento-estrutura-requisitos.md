...
[2\. Fundamentação da Estrutura Adotada	3](#fundamentação-da-estrutura-adotada)

[2.1 Clareza e comunicação entre áreas	3](#2.1-clareza-e-comunicação-entre-áreas)

[2.2 Flexibilidade e profundidade técnica	3](#2.2-flexibilidade-e-profundidade-técnica)

[3\. Organização em Épicos	4](#organização-em-épicos)

[3.1 Nota sobre a terminologia adotada	5](#3.1-nota-sobre-a-terminologia-adotada)

[4\. Modelo de Estrutura da Especificação dos Requisitos Funcionais	5](#modelo-de-estrutura-da-especificação-dos-requisitos-funcionais)

[5\. Comparativo com Outras Estruturas	6](#comparativo-com-outras-estruturas)
